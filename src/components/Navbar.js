            ...
            <div className="flex items-center">
              <div className="flex-shrink-0">
                {/* <img
                  ...
                  alt="Workflow"
                /> */}
                <div className="text-white block px-3 py-2 rounded-md text-xl font-medium">Smart UPS</div>
              </div>
              <div className="hidden md:block">
                <div className="flex items-baseline absolute inset-y-3 right-10 space-x-6">
